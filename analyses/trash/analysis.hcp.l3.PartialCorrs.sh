...
#partialCorrs_hcpl3="$layer4EPI/partialCorrs_hcpl3"
#mkdir $partialCorrs_hcpl3

mkdir $DensParcorr_hcpl3
...
Rscript --vanilla ${tools_dir}/gen_DensParcorr.R  $matrix_hcpl3_thalamic $DensParcorr_hcpl3
