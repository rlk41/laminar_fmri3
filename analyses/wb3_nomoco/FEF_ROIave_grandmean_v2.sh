...
analysis_dir="$my_scratch/analyses/wb3_nomoco/${note}_PC${pca_num}_all${epi_num}_nomask"
...
do    
    ...
    echo "run_swarm_wb3_permute.sh -r $roi_path -p $pca_num  -o $out_dir -A -X" | tee -a $swarm_submit
