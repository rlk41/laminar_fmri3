...
analysis_dir="$my_scratch/analyses/seedLayers_FEF_nullseeds"
...
do    
    ...
    echo "run_laminar_permute_swarm.sh -r $roi_path -p 0 -o $out_dir -X " | tee -a $swarm_submit
...
# if -X included 
dep_prepare_submit=$(swarm -b 10 -f $swarm_submit -g 10)
...
# run_laminar_permute_post.sh -d /data/NIMH_scratch/kleinrl/analyses/seedLayers_FEF_nullseeds/fsl_feat_seed1_ave_single -f thresh_zstat1.nii.gz
# L2D.job.sh /data/NIMH_scratch/kleinrl/analyses/seedLayers_FEF_nullseeds/fsl_feat_seed1_ave_single/mean 3
