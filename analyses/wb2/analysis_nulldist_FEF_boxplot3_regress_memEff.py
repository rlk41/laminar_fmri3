...
def get_plots(base_dir, k=None, c=None, fwhm=7, y_label='', plot_dir=None): 
    ...
    feat_3d             = glob.glob(base_dir+"/fsl_feat_1010.L_FEF_pca10/mean/inv_pe1.fwhm{}.nii.gz".format(fwhm)) #L2D.columns_ev_30000_borders.downscaled2x_NN.nii.gz")
    feat_3d             = feat_3d[0]
    ...
    for uc in unq_roi_col: 
        ...
        plt.savefig(plot_dir+"/{}.regress.SD.box8.png".format(save_tit))
        ...
        plt.savefig(plot_dir+"/{}.regress.SE.box8.png".format(save_tit))
        ...
        plt.savefig(plot_dir+"/{}.regress.bp.box8.png".format(save_tit))
