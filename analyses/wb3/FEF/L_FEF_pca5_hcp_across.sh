...
analysis_dir="$my_scratch/analyses/wb3/L_FEF_pca5_hcp_across"
...
for out_dir in $analysis_dir/fsl_feat_*; do 
    ...
    echo "run_laminar_permute_post.zstat.sh -d $out_dir" | tee -a $swarm_merged_dir/swarm_merged.post 
    ...
    # L2D.job.wb2.sh $(pwd) 1 thresh_zstat1.nii
