...
analysis_dir="$my_scratch/analyses/wb3/FEF/L_FEF_AVE_CORR_byLayer"
...
3dcalc -a $deriv_hcp -expr 'equals(a,1010)' -overwrite -prefix FEF.nii.gz
...
do    
    ...
    echo "run_swarm_wb3.sh -r $roi_path -p 0 -C -o $out_dir -X" | tee -a $swarm_submit
