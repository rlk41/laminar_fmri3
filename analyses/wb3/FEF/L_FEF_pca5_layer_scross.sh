...
source_wholebrain3.0


analysis_dir="$my_scratch/analyses_wb3/L_FEF_pca5_layer_across"
...
# VASO_across="/data/NIMH_scratch/kleinrl/gdown/sub-02_VASO_across_days.nii"
# VASO_across_mean="/data/NIMH_scratch/kleinrl/gdown/sub-02_VASO_across_days.mean.nii"

# layers="/data/NIMH_scratch/kleinrl/gdown/sub-02_layers.nii"
# parc_dir='/data/kleinrl/Wholebrain2.0/ANAT/ANAT_working_recon-all/ANAT_mri_make_surf/multiAtlasTT/hcp-mmp-b/'
# parc_hcp="${parc_dir}/warped_hcp-mmp-b_rmap.nii"
# parc_hcp_wb3="${parc_dir}/wb3_warped_hcp-mmp-b_rmap.nii.gz"

# parc_30k="/data/kleinrl/Wholebrain2.0/ANAT/ANAT_working_recon-all/ANAT_mri_make_surf/LAYNII_2/columns/warped_columns_ev_30000_borders.nii"
# parc_30k_wb3="${parc_dir}/wb3_warped_columns_ev_30000_borders.nii.gz"
...
3dcalc -a l01.nii.gz -b l02.nii.gz -expr 'or(a,b)' -overwrite -prefix wm.nii.gz 
3dcalc -a l03.nii.gz -b l04.nii.gz -c l05.nii.gz -expr 'or(a,b,c)' -overwrite -prefix mid.nii.gz 
3dcalc -a l06.nii.gz -b l07.nii.gz -expr 'or(a,b)' -overwrite -prefix csf.nii.gz 
...
do    
    ...
    echo "run_laminar_permute_swarm.sh -r $roi_path -p 5 -o $out_dir -X -A " | tee -a $swarm_submit
