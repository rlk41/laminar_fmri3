...
echo "layZii_aim1.sh -r $roi_list -p $pca_num -i $i -s $s -d $dir_emp -Z" | tee -a $submit_layzii
#echo "layZii_aim1.sh -r $roi_list -p $pca_num -i $i -s $s -d $dir_null -N -Z" | tee -a $submit_layzii
