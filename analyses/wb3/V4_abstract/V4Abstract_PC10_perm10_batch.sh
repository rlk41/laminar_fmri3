...
pca_num="10"
#epi_num="10"
title="V4Abstract-wb2epi-10pc"

"ROI_AVE/FSLFEAT_PERMUTE/GRANDMEAN_#PCS_#EPIS_EPIRANGE_NULL"




analysis_dir="$my_scratch/analyses/wb3/${title}"
...
do    
    ...
    echo "run_swarm_wb3_permute.sh -r $roi_path -p $pca_num -s 14 -i perm -o $out_dir -B -A -X -Z" | tee -a $swarm_submit
...
echo "create_post_merge_and_L2D_jobs_wb2.sh $analysis_dir " > $post_merge_L2D_job 




dep_setup=$(swarm -b 5 -f $swarm_submit -g 10 --job-name 01setup )
