...
analysis_dir="$my_scratch/analyses/wb3/FEF_aim1/all_auto_v2"
...
for epi_num in 1 5 10 15; do 
    ...
    echo "run_swarm_wb3_permute.sh -r $roi_path -p $pca_num -s $epi_num -o $out_dir -i $imp_type -A -X" | tee -a $swarm_submit
