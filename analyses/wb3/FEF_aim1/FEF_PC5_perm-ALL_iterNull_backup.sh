...
analysis_dir="$my_scratch/analyses/wb3/FEF_aim1/all_auto_iterNULL_backup"
...
for epi_num in 1 5 10 15 20; do 
    ...
    echo "run_swarm_wb3_permute_backup.sh -r $roi_path -p $pca_num -s $epi_num -o $out_dir -A -X" | tee -a $swarm_submit
    echo "run_swarm_wb3_permute_backup.sh -r $roi_path -p $pca_num -s $epi_num -o $out_dir_null  -N -A -X" | tee -a $swarm_submit
