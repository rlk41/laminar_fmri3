...
# ls $rois_hcp | grep TE
rois=(
$rois_hcp_kenshu/*.L_11l.nii
$rois_hcp_kenshu/*.L_13l.nii

$rois_hcp_kenshu/*.L_FOP4.nii
$rois_hcp_kenshu/*.L_FOP1.nii
$rois_hcp_kenshu/*.L_FOP3.nii
$rois_hcp_kenshu/*.L_FOP2.nii
$rois_hcp_kenshu/*.L_FOP5.nii

$rois_hcp_kenshu/*.L_AAIC.nii
$rois_hcp_kenshu/*.L_AVI.nii

$rois_hcp_kenshu/*.L_Ig.nii
$rois_hcp_kenshu/*.L_MI.nii

$rois_hcp_kenshu/*.L_PoI2.nii
$rois_hcp_kenshu/*.L_PoI1.nii
$rois_hcp_kenshu/*.L_Pir.nii
$rois_hcp_kenshu/*.L_PI.nii

$rois_hcp_kenshu/*.L_STSda.nii
$rois_hcp_kenshu/*.L_STSdp.nii
$rois_hcp_kenshu/*.L_STSvp.nii
$rois_hcp_kenshu/*.L_STSva.nii

$rois_hcp_kenshu/*.L_STGa.nii

$rois_hcp_kenshu/*.L_TE1a.nii
$rois_hcp_kenshu/*.L_TE1p.nii
$rois_hcp_kenshu/*.L_TE2a.nii
$rois_hcp_kenshu/*.L_TE2p.nii
$rois_hcp_kenshu/*.L_TE1m.nii
$rois_hcp_kenshu/*.R_TE1a.nii
$rois_hcp_kenshu/*.R_TE1p.nii
$rois_hcp_kenshu/*.R_TE2a.nii
$rois_hcp_kenshu/*.R_TE2p.nii
$rois_hcp_kenshu/*.R_TE1m.nii

$rois_hcp_kenshu/*.L_TGd.nii
$rois_hcp_kenshu/*.L_TGv.nii

$rois_hcp_kenshu/*.L_TF.nii

$rois_hcp_kenshu/*.L_PeEc.nii
$rois_hcp_kenshu/*.L_EC.nii

$rois_hcp_kenshu/*.L_H.nii

$rois_hcp_kenshu/*.L_24dd.nii
$rois_hcp_kenshu/*.L_24dv.nii
$rois_hcp_kenshu/*.L_p24pr.nii
$rois_hcp_kenshu/*.L_a24pr.nii
$rois_hcp_kenshu/*.L_a24.nii
$rois_hcp_kenshu/*.L_p24.nii

$rois_hcp_kenshu/*.L_25.nii

$rois_hcp_kenshu/*.L_p32pr.nii
$rois_hcp_kenshu/*.L_d32.nii
$rois_hcp_kenshu/*.L_p32.nii
$rois_hcp_kenshu/*.L_s32.nii
$rois_hcp_kenshu/*.L_a32pr.nii
)
...
do    
    ...
    out_dir=$analysis_dir/fsl_feat_${c}_pca${pca_num}

    mkdir -p $out_dir
    #cp $roi_path  $out_dir/roi 
    echo "pca 5 perm 10 roi $roi_path fsl_feat" > $out_dir/config.txt
    echo "run_swarm_wb3_permute.sh -r $roi_path -p $pca_num -s 10 -o $out_dir -A -X" | tee -a $swarm_submit
