...
# grnad mean, whole roi, layers usign kenshu ROIs 

'''
new ROIs including layers and whole 
...
pca_num="0"
epi_num="0"
note="FEF_grandmean_kenshu_v2"


analysis_dir="$my_scratch/analyses/wb3/${note}_PC${pca_num}_all${epi_num}_nomask"
...
do    
    ...
    echo "run_swarm_wb3_permute_grandmean_batch.sh -r $roi_path -p $pca_num -s 1 -o $out_dir -A -X" | tee -a $swarm_submit
