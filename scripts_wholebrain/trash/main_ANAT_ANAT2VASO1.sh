...
# set required paths!
source /home/kleinrl/projects/laminar_fmri/paths_ANAT2VASO1
...
cp /data/kleinrl/Wholebrain2.0/ANAT/ANAT2VASO1/warped_brainmask.manualedits3.mgz $recon_dir/mri/warped_brainmask.manualedits3.mgz
cp $recon_dir/mri/warped_brainmask.manualedits3.mgz $recon_dir/mri/brainmask.mgz 

cp /data/kleinrl/Wholebrain2.0/ANAT/ANAT2VASO1/warped_wm.manualedits2.mgz $recon_dir/mri/warped_wm.manualedits2.mgz
cp $recon_dir/mri/warped_wm.manualedits2.mgz $recon_dir/mri/wm.mgz 
