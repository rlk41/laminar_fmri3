...
# set required paths!
source /home/kleinrl/projects/laminar_fmri/paths_VASO2ANAT
...
# mv $recon_dir/mri/wm.mgz $recon_dir/mri/wm.orig.mgz
# mv $recon_dir/mri/brainmask.mgz $recon_dir/mri/brainmask.orig.mgz

cp -r $recon_dir $SUBJECTS_DIR/inv_EPI_post-ALL



cp /data/kleinrl/Wholebrain2.0/ANAT_working_ANTs/inv_warped_brainmask.manualedits3.mgz $recon_dir/mri/inv_warped_brainmask.manualedits3.mgz
cp $recon_dir/mri/inv_warped_brainmask.manualedits3.mgz $recon_dir/mri/brainmask.mgz 

cp /data/kleinrl/Wholebrain2.0/ANAT_working_ANTs/inv_warped_wm.manualedits2.mgz $recon_dir/mri/inv_warped_wm.manualedits2.mgz
cp $recon_dir/mri/inv_warped_wm.manualedits2.mgz $recon_dir/mri/wm.mgz 
...
cp -r $recon_dir $SUBJECTS_DIR/inv_EPI_post-pial
...
cp -r $recon_dir $SUBJECTS_DIR/inv_EPI_post-wm-AR3
