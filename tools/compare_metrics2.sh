...
seed_base=$(basename $(basename $seed .nii.gz) .nii) 

out_file_corr=$out_dir/$epi_base-$seed_base-CORR.nii.gz
out_file_DECONV=$out_dir/$epi_base-$seed_base-DECONV.nii.gz
