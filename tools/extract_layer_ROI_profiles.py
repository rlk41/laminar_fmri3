...
def get_rois(epi, parc, layers, out):


    '''
    epi="/gpfs/gsfs12/users/NIMH_scratch/kleinrl/analyses/wb3/LANG_pca5_fslmask_AVE/fsl_feat_1140.L_TPOJ2_pca10/mean/thresh_zstat1.fwhm5.nii.gz"
